...
class Employee
  ...
  ## But on line 56, in Employee#==, we do invoke serial_number with an explicit caller (other).
  ## In order to make this work, we can make serial_number a protected method. Recall that from outside the class, protected methods work just like private methods. 
  ## From inside the class, however, protected methods are accessible and may be invoked with an explicit caller.
